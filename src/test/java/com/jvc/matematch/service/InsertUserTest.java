...
//            User user = new User();
//            user.setUsername("roseTest");
//            user.setUserAccount("rose1");
//            user.setAvatarUrl("https://i.pinimg.com/474x/d8/76/60/d87660dc503ecdce12459187e4d095c0.jpg");
//            user.setProfile("一条咸鱼");
//            user.setGender(0);
//            user.setUserPassword("12345678");
//            user.setPhone("123456789108");
//            user.setEmail("rosesarerosie@qq.com");
